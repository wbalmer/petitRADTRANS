...
module fortran_radtrans_core
    ...
    contains
        subroutine m_compute_planck_function_integral(temperatures, n_layers, &
        ...
        end subroutine m_compute_planck_function_integral
        ...
        subroutine compute_rosseland_opacities(opacities, temperatures, weights_gauss, frequencies_bin_edges, &
            ...
            do i_struc = 1, n_layers
                call m_compute_rosseland_opacities( &
        ...
        subroutine compute_planck_opacities(opacities, temperatures, weights_gauss, frequencies_bin_edges, &
            ...
            do i_struc = 1, n_layers
                call m_compute_planck_opacities(&
                    total_kappa_use(:,:,i_struc), &
                    frequencies_bin_edges, &
                    temperatures(i_struc), &
                    n_g, &
        ...
        subroutine interpolate_cloud_opacities(clouds_total_absorption_opacities, clouds_total_scattering_opacities, &
          ...
          do HIT_i_lamb = 1, n_frequencies_bins-1
             ...
             if ((intp_index_small_max-intp_index_small_min) == 0) then
                ...
                call m_intergrate_opacities(intp_index_small_min,n_cloud_wavelengths,n_layers,&
                    clouds_total_absorption_opacities, &
                ...
                call m_intergrate_opacities(intp_index_small_max,n_cloud_wavelengths,n_layers,&
                    clouds_total_absorption_opacities, &
                ...
                do while (intp_index_small_max-new_small_ind /= 0)
                   ...
                   call m_intergrate_opacities(new_small_ind,n_cloud_wavelengths,n_layers,&
                        clouds_total_absorption_opacities, &
        ...
        subroutine m_intergrate_opacities(intp_ind,n_cloud_wavelengths,n_layers,kappa,lambda,l_bord1,l_bord2,&
                                               kappa_integ)
            ! """
        ...
        end subroutine m_intergrate_opacities
        ...
        subroutine compute_cloud_particles_mean_radius(surface_gravity, atmospheric_densities, &
          ...
          do i_str = 1, n_layers
             do i_spec = 1, n_clouds
                r_w(i_str,i_spec) = m_compute_particle_radius(&
                ...
                if (r_w(i_str,i_spec) > 1d-16) then
                   if (f_seds(i_spec) > 1d0) then
                      do i_rad = 1, N_fit
                         ...
                         call m_compute_turbulent_settling_speed(&
                   ...
                   call  m_linear_fit(log(rad), log(vel/w_star(i_str)), N_fit, a, b)
        ...
        subroutine m_compute_turbulent_settling_speed(x,surface_gravity,rho,clouds_particles_densities,&
                                                            temperatures, mean_molar_masses, &
        ...
        end subroutine m_compute_turbulent_settling_speed


        function m_compute_particle_radius(x1,x2,surface_gravity,rho,clouds_particles_densities,temperatures,&
          ...
          double precision :: m_compute_particle_radius,x1,x2
          integer :: iter
          ...
          if((fa>0..and.fb>0.).or.(fa<0..and.fb<0.)) then
             ...
             m_compute_particle_radius = 1d-17
             return
          end if
          ...
          m_compute_particle_radius = c
          return

        end function m_compute_particle_radius


        subroutine  m_linear_fit(x, y, ndata, a, b)
            ! """
        ...
        end subroutine  m_linear_fit


        subroutine  m_linear_interpolate(x,y,x_out,input_len,output_len,y_out)
            ...
            call m_find_interpolate_indices(x, input_len, x_out, output_len, interp_ind)
            ...
            enddo
        end subroutine  m_linear_interpolate
                ...
                do i_struc = 1, n_layers
                    do i_freq = 1, n_frequencies
                        do i_spec = 2, n_species
                            ...
                            call  m_linear_interpolate(g_out, k_out, g_gauss, n_sample + 1, n_g, &
        ...
        subroutine m_find_interpolate_indices(binbord,binbordlen,arr,arrlen,intpint)
            ! """
        ...
        end subroutine m_find_interpolate_indices
        ...
        subroutine unused_compute_olson_kunasz_ck_radiative_transfer(&
            ...
            call m_compute_planck_function_integral(&
...
!if(i == 800 .and. l == 8) print*,dtau_1_level(50),dtau_2_level(50)
        ...
        subroutine m_compute_rosseland_opacities(clouds_final_absorption_opacities,frequencies_bin_edges,temperatures,&
          ...
          call m_compute_planck_function_temperature_derivative(&
        ...
        end subroutine m_compute_rosseland_opacities


        subroutine m_compute_planck_function_temperature_derivative(n_frequencies,temperatures,frequencies,&
                                                                          B_nu_dT)
        ...
        end subroutine m_compute_planck_function_temperature_derivative


        subroutine m_compute_planck_opacities(clouds_final_absorption_opacities,frequencies_bin_edges,temperatures,&
                                                    HIT_N_g,n_frequencies_bins, &
          ...
          call m_compute_star_plack_function_integral(n_frequencies_bins,temperatures,frequencies_bin_edges,&
                                                            planck_flux)
        ...
        end subroutine m_compute_planck_opacities


        subroutine m_compute_star_plack_function_integral(n_frequencies,temperatures,frequencies,planck_flux)
            use physical_constants
        ...
        end subroutine m_compute_star_plack_function_integral
