...
plt.plot(nc.c / atmosphere.frequencies / 1e-4, atmosphere.transm_rad / nc.r_jup_mean, label ='HITEMP')
plt.plot(nc.c / atmosphere.frequencies / 1e-4, atmosphere2.transm_rad / nc.r_jup_mean, label ='Exomol')
