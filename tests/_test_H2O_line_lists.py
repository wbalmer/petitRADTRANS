...
atmosphere2 = Radtrans(line_species = ['H2O_Exomol', 'CO-NatAbund_HITEMP', 'CH4', 'CO2', 'Na_allard', 'K_allard'], \
                          rayleigh_species = ['H2', 'He'], \
                          continuum_opacities = ['H2-H2', 'H2-He'], \
                          wlen_bords_micron = [0.3, 15])
...
plt.plot(cst.c / atmosphere._frequencies / 1e-4, atmosphere.transit_radii / cst.r_jup_mean, label ='HITEMP')
