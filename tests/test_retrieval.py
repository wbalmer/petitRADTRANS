...
# TODO MultiNest's random generator is computer-dependent (on Mac only?), the tolerance is temporarily increased to match this until a fix is found  # noqa E501
...
def retrieval_model_spec_iso(prt_object, parameters, pt_plot_mode=None, amr=False):
    ...
    for species in prt_object.line_species:
        spec = Opacity([species]).get_full_name()  # deal with the naming scheme for binned down opacities
